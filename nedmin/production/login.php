...
<head>
  ...
  <title> Nano Ajans C2C Scripti </title>
          ...
          <form action="../netting/islem.php" method="POST">
            ...
            <div class="separator">
             ...
             ?>
              ...
              <div>
                <h1><i class="fa fa-paw"></i> Nano Ajans </h1>
                <p><strong>Admin Kullanıcı Ad:</strong>info@nanoajans.com</p>
                <p><strong>Admin Parola:</strong>123456</p>
                <p>©2020 C2C Scripti v-1.0</p>
              </div>
            </div>
          </form>
